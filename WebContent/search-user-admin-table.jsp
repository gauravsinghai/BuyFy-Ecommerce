...
<body>
		...
		<div class="text-center">
			<h1>
				<span class="badge badge-primary p-3 mt-3 text-4xl">
					Search result for ${requestScope.query}
				</span>
			</h1>
		</div>
		<c:choose>
			<c:when test="${not empty requestScope.adminsearchusers}">
				...
				<section class="text-gray-700 body-font">
					<div class="container px-5 py-24 mx-auto">
						<div class="flex flex-wrap -m-2">
							<c:forEach var="user" items="${requestScope.adminsearchusers}">
			...
			<c:otherwise>
				<h1>
					<span class="badge badge-danger text-4xl text-center mb-5">
						No Users Found!
					</span>
				</h1>
			</c:otherwise>
	...
	$("#searchuser").val(`${requestScope.query}`);
	// For Deleting user
