...
parameters.put("MOBILE_NO","9312376463");
parameters.put("EMAIL","raghvendras28071@gmail.com");
parameters.put("CALLBACK_URL", "http://localhost:8081/BuyFy/PaytmResponseServ");
